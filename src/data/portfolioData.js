export const PORTFOLIO_DATA = {
  personal: {
    ...
    subheadline: 'Chuyên xây dựng các ứng dụng web tương tác cao, thiết kế giao diện Glassmorphism đỉnh cao và mang đến trải nghiệm thị giác sống động như dải ngân hà.',
  ...
  stats: [
    { label: 'Năm kinh nghiệm', value: '4+', icon: 'Sparkles', color: 'from-purple-500 to-indigo-500' },
    { label: 'Dự án hoàn thành', value: '28+', icon: 'Rocket', color: 'from-cyan-500 to-blue-500' },
    { label: 'Tỉ lệ hài lòng', value: '99%', icon: 'Award', color: 'from-pink-500 to-rose-500' },
    { label: 'Cốc cà phê & Code', value: '1.4K', icon: 'Coffee', color: 'from-amber-500 to-orange-500' }
  ],

  about: {
    bio: {
      title: 'Tiểu sử & Hành trình',
      subtitle: 'Từ niềm đam mê thiên văn học đến nghệ thuật lập trình Frontend',
      content: [
  ...
  projects: [
    {
      ...
      subtitle: 'Hệ thống mô phỏng hệ mặt trời và các hành tinh ngoại với hiệu ứng không gian 3D tương tác.',
      category: 'Web App',
    ...
    },
    {
      ...
      subtitle: 'Thư viện giao diện Glassmorphism cao cấp dành cho React với hơn 40+ components tùy biến.',
    ...
    },
    {
      ...
      subtitle: 'Bảng điều khiển theo dõi vệ tinh và dữ liệu khí tượng không gian theo thời gian thực.',
      category: 'Web App',
    ...
    },
    {
      ...
      subtitle: 'Nền tảng xem phim trực tuyến với giao diện kính mờ đổi màu theo poster phim.',
      category: 'Frontend',
    ...
    },
    {
      ...
      subtitle: 'Ứng dụng quản lý dự án phong cách Obsidian Glass với âm thanh vũ trụ thư giãn.',
      category: 'Web App',
    ...
    },
    {
      ...
      subtitle: 'Trợ lý ảo AI thông minh với giao diện hạt sao tương tác bằng giọng nói.',
      category: 'Frontend',
  ...
  contact: {
    ...
    subtitle: 'Bạn có một ý tưởng dự án ấn tượng hoặc muốn thảo luận về cơ hội hợp tác? Hãy gửi tin nhắn cho tôi!',
    direct: {
      email: 'alex.cosmic.dev@gmail.com',
